...
const productSchema = new mongoose.Schema({
  ...
  description: String,
  seoTitle: { type: String, maxlength: 200, default: '' },
  seoDescription: { type: String, maxlength: 500, default: '' },
  focusKeywords: [{ type: String, maxlength: 80 }],
  shippingTitle: { type: String, maxlength: 160, default: '' },
  shippingText: { type: String, maxlength: 4000, default: '' },
  deliveryText: { type: String, maxlength: 2000, default: '' },
  shippingBullets: [{ type: String, maxlength: 2000 }],
  hidePrice: { type: Boolean, required: true, default: false },
  hideCart: { type: Boolean, required: true, default: false },
  showOnHomepage: { type: Boolean, required: true, default: true },
...
const orderSchema = new mongoose.Schema({
  ...
  netPayout: Number,
  feeProvider: { type: String, maxlength: 40 },
